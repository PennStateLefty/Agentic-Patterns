...
![Router logical component architecture](diagrams/router-dispatcher/logical.svg)
...
![Router low-code component architecture](diagrams/router-dispatcher/low-code.svg)
...
![Router managed pro-code component architecture](diagrams/router-dispatcher/managed-pro-code.svg)
...
![Router custom code-first component architecture](diagrams/router-dispatcher/custom-code-first.svg)
...
![Plan-and-Execute logical component architecture](diagrams/plan-and-execute/logical.svg)
...
![Plan-and-Execute low-code component architecture](diagrams/plan-and-execute/low-code.svg)
...
![Plan-and-Execute managed pro-code component architecture](diagrams/plan-and-execute/managed-pro-code.svg)
...
![Plan-and-Execute custom code-first component architecture](diagrams/plan-and-execute/custom-code-first.svg)
...
![Sequential Pipeline logical component architecture](diagrams/sequential-pipeline/logical.svg)
...
![Sequential Pipeline low-code component architecture](diagrams/sequential-pipeline/low-code.svg)
...
![Sequential Pipeline managed pro-code component architecture](diagrams/sequential-pipeline/managed-pro-code.svg)
...
![Sequential Pipeline custom code-first component architecture](diagrams/sequential-pipeline/custom-code-first.svg)
...
![Parallel Fan-Out/Fan-In logical component architecture](diagrams/parallel-fan-out/logical.svg)
...
![Parallel Fan-Out/Fan-In low-code component architecture](diagrams/parallel-fan-out/low-code.svg)
...
![Parallel Fan-Out/Fan-In managed pro-code component architecture](diagrams/parallel-fan-out/managed-pro-code.svg)
...
![Parallel Fan-Out/Fan-In custom code-first component architecture](diagrams/parallel-fan-out/custom-code-first.svg)
...
![Supervisor / Manager-Worker logical component architecture](diagrams/supervisor/logical.svg)
...
![Supervisor / Manager-Worker low-code component architecture](diagrams/supervisor/low-code.svg)
...
![Supervisor / Manager-Worker managed pro-code component architecture](diagrams/supervisor/managed-pro-code.svg)
...
![Supervisor / Manager-Worker custom code-first component architecture](diagrams/supervisor/custom-code-first.svg)
...
![Handoff / Decentralized logical component architecture](diagrams/handoff/logical.svg)
...
![Handoff / Decentralized low-code component architecture](diagrams/handoff/low-code.svg)
...
![Handoff / Decentralized managed pro-code component architecture](diagrams/handoff/managed-pro-code.svg)
...
![Handoff / Decentralized custom code-first component architecture](diagrams/handoff/custom-code-first.svg)
...
![Group Chat / Shared Conversation logical component architecture](diagrams/group-chat/logical.svg)
...
![Group Chat / Shared Conversation low-code component architecture](diagrams/group-chat/low-code.svg)
...
![Group Chat / Shared Conversation managed pro-code component architecture](diagrams/group-chat/managed-pro-code.svg)
...
![Group Chat / Shared Conversation custom code-first component architecture](diagrams/group-chat/custom-code-first.svg)
...
![Evaluator-Optimizer logical component architecture](diagrams/evaluator-optimizer/logical.svg)
...
![Evaluator-Optimizer low-code component architecture](diagrams/evaluator-optimizer/low-code.svg)
...
![Evaluator-Optimizer managed pro-code component architecture](diagrams/evaluator-optimizer/managed-pro-code.svg)
...
![Evaluator-Optimizer custom code-first component architecture](diagrams/evaluator-optimizer/custom-code-first.svg)
...
![Conditional Graph / State Machine logical component architecture](diagrams/conditional-graph/logical.svg)
...
![Conditional Graph / State Machine low-code component architecture](diagrams/conditional-graph/low-code.svg)
...
![Conditional Graph / State Machine managed pro-code component architecture](diagrams/conditional-graph/managed-pro-code.svg)
...
![Conditional Graph / State Machine custom code-first component architecture](diagrams/conditional-graph/custom-code-first.svg)
...
![Blackboard / Shared Workspace logical component architecture](diagrams/blackboard/logical.svg)
...
![Blackboard / Shared Workspace low-code component architecture](diagrams/blackboard/low-code.svg)
...
![Blackboard / Shared Workspace managed pro-code component architecture](diagrams/blackboard/managed-pro-code.svg)
...
![Blackboard / Shared Workspace custom code-first component architecture](diagrams/blackboard/custom-code-first.svg)
